...
/*   Updated: 2022/05/02 20:01:51 by jkangas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_ui(t_fdf *data)
{
	...
	str5 = "Use [ and ] to change the elevation";
	str6 = "Press esc to exit";
	...
	mlx_string_put(data->mlx, data->win, 20, 150, rgb_to_int(1, 1, 1), str6);
}
